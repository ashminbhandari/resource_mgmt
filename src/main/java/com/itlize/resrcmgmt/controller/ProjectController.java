...
//        System.out.println(column_value);
    ...
    List<com.itlize.resrcmgmt.entity.ProjectColumnValue> getAllColumn(){
        List<com.itlize.resrcmgmt.entity.ProjectColumnValue> projectColumnValues = new ArrayList<>();
        ...
        for(Project project:projects){
           ...
           projectColumnValues.add(new com.itlize.resrcmgmt.entity.ProjectColumnValue(project, column_value));
        }
